#!/bin/bash
# taotao-cloud-order 安全扫描脚本
# 用于检查 DDD 项目中的常见安全问题

echo "================================================"
echo "  taotao-cloud-order 安全扫描"
echo "================================================"

# 扫描配置
BASE_DIR="."
MODULES=("taotao-cloud-order-api" "taotao-cloud-order-application" "taotao-cloud-order-domain" "taotao-cloud-order-infrastructure" "taotao-cloud-order-interfaces")
HAS_WARNINGS=0
