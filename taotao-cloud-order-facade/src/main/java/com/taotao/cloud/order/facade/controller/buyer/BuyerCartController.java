...
public class BuyerCartController extends BusinessController {
	//
    ///**
    // * 购物车
    // */
    ...
    //    return Result.success(cartCommandService.add(skuId, num, cartType, false));
    //}
	//
    ...
    //    return Result.success(this.cartCommandService.getAllTradeDTO());
    //}
	//
    ...
    //    return Result.success(this.cartCommandService.getCartNum(checked));
    //}
	//
    ...
    //    return Result.success(this.cartCommandService.getCanUseCoupon(CartTypeEnum.valueOf(way)));
    //}
	//
    ...
    //    return Result.success(this.cartCommandService.getCheckedTradeDTO(CartTypeEnum.valueOf(way)));
    //}
	//
