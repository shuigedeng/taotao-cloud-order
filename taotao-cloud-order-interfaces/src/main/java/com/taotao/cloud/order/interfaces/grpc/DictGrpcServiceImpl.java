...
// import com.taotao.cloud.order.api.grpc.DictGrpcRequest;
// import com.taotao.cloud.order.api.grpc.DictGrpcResponse;
// import com.taotao.cloud.order.api.grpc.DictGrpcServiceGrpc.DictGrpcServiceImplBase;
// import com.taotao.cloud.order.api.grpc.DictTestGrpcRequest;
...
//            update = {
//                @Update(version = V2022_07, content = "主要修改了配置信息的接口查询", date = "2022-07-01
// 17:11:55"),
//                @Update(version = V2022_08, content = "主要修改了配置信息的接口查询08", date = "2022-07-08
// 15:12:55")
//            },
//            caller = {
...
//            })
//    @Override
//    public void findByCode(DictGrpcRequest request, StreamObserver<DictGrpcResponse>
// responseObserver) {
...
//
//    @Override
//    public void test(DictTestGrpcRequest request, StreamObserver<DictGrpcResponse>
// responseObserver) {
