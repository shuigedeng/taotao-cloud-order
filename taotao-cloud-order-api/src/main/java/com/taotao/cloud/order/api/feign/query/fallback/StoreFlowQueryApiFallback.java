...
import com.taotao.cloud.order.api.feign.query.StoreFlowQueryApi;
 ...
 */
public class StoreFlowQueryApiFallback implements FallbackFactory<StoreFlowQueryApi> {

	@Override
	public StoreFlowQueryApi create(Throwable throwable) {
		return new StoreFlowQueryApi() {
