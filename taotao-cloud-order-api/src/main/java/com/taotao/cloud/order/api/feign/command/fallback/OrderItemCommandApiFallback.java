...
import com.taotao.cloud.order.api.feign.command.OrderItemCommandApi;
 ...
 */
public class OrderItemCommandApiFallback implements FallbackFactory<OrderItemCommandApi> {

	@Override
	public OrderItemCommandApi create(Throwable throwable) {
		return new OrderItemCommandApi() {
			@Override
