...
import com.taotao.cloud.order.api.feign.query.TradeQueryApi;
 ...
 */
public class TradeQueryApiFallback implements FallbackFactory<TradeQueryApi> {

    @Override
    public TradeQueryApi create(Throwable throwable) {
        return new TradeQueryApi() {
