...
package com.taotao.cloud.order.domain.order.valobj.plan;
...
public class Plan {
    ...
    private static final Set<ControlType> BASIC_PLAN_EXCLUDES =
            Set.of(VIDEO_VIEW, TIME_SEGMENT, NUMBER_RANGE_SEGMENT, MEMBER_SELECT, ITEM_COUNT);

    // 只有FREE版本套餐经过单独提权设置，进而用于码如云在线免费服务，其他类型套餐均保留商业化阶梯分布
    public static final Plan FREE_PLAN =
            Plan.builder()
                    .type(FREE)
                    .maxAppCount(5)
                    .maxQrCount(10000)
    ...
    public static final Plan BASIC_PLAN =
            Plan.builder()
                    .type(BASIC)
                    .maxAppCount(5)
                    .maxQrCount(10000)
    ...
    public static final Plan ADVANCED_PLAN =
            Plan.builder()
                    .type(ADVANCED)
                    .maxAppCount(20)
                    .maxQrCount(100000)
    ...
    public static final Plan PROFESSIONAL_PLAN =
            Plan.builder()
                    .type(PROFESSIONAL)
                    .maxAppCount(50)
                    .maxQrCount(300000)
    ...
    public static final Plan FLAGSHIP_PLAN =
            Plan.builder()
                    .type(FLAGSHIP)
                    .maxAppCount(100)
                    .maxQrCount(1000000)
    ...
    private static Map<PlanType, Plan> ALL_PLANS =
            Map.of(
                    FREE, FREE_PLAN,
                    BASIC, BASIC_PLAN,
    ...
    private static Set<ControlType> freePlanControlTypes() {
        ...
        return controlTypes.stream()
                .filter(controlType -> !FREE_PLAN_EXCLUDES.contains(controlType))
    ...
    private static Set<ControlType> basicPlanControlTypes() {
        Set<ControlType> controlTypes = allControlTypes();
        return controlTypes.stream()
                .filter(controlType -> !BASIC_PLAN_EXCLUDES.contains(controlType))
                .collect(toImmutableSet());
    }
