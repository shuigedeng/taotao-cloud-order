...
public interface OrderLogQueryService {
    List<OrderLogResult> getOrderLog(String orderSn);

    IPage<OrderLogResult> pageQuery(OrderLogPageQuery orderLogPageQuery);

    List<OrderLogResult> queryOrderLog(String orderSn);

    OrderLogResult queryById(String id);
}
