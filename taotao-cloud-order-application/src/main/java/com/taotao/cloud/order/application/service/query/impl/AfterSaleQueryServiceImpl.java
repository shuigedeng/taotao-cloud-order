...
public class AfterSaleQueryServiceImpl implements AfterSaleQueryService {
    ...
    @Override
    public List<AfterSaleResult> exportAfterSaleOrder(AfterSalePageQuery afterSalePageQry) {
        return null;
    }

    @Override
    public AfterSaleResult queryAfterSaleBySn(String sn) {
        return null;
    }

    @Override
    public AfterSaleApplyResult queryAfterSaleApply(String sn) {
        return null;
    }

    @Override
    public StoreAfterSaleAddressResult queryStoreAfterSaleAddress(String sn) {
        return null;
    }

    @Override
    public Object deliveryTraces(String afterSaleSn) {
        return null;
    }
}
