...
import com.taotao.cloud.order.application.service.query.PurchaseQuotedItemQueryService;
...
public class PurchaseQuotedItemQueryServiceImpl implements PurchaseQuotedItemQueryService {
    ...
    @Override
    public List<PurchaseQuotedItemResult> purchaseQuotedItemList(String purchaseQuotedId) {
        return List.of();
    }
}
