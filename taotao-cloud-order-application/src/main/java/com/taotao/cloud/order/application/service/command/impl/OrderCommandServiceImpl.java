...
public class OrderCommandServiceImpl implements OrderCommandService {
    ...
    //
    //	@Override
    //	public List<OrderPO> queryListByPromotion(String orderPromotionType, String payStatus, String
    // parentOrderSn, String orderSn) {
    //		return List.of();
    //	}
    //
    //	@Override
    //	public long queryCountByPromotion(String orderPromotionType, String payStatus, String
    // parentOrderSn, String orderSn) {
    //		return 0;
    //	}
    //
    ...
    //
    //	@Override
    //	public IPage<PaymentLogCO> queryPaymentLogs(IPage<PaymentLogCO> page, Wrapper<PaymentLogCO>
    // queryWrapper) {
    //		return null;
    //	}
    ...
    // * 订单流水
    // */
    // private final StoreFlowQueryService storeFlowQueryService;
    /// **
    // * 拼团
    // */
    ...
    //	// 批量保存 子订单
    //	orderItemCommandService.saveBatch(orderItems);
    //	// 批量记录订单操作日志
    ...
    //	// 查询发票信息
    //	ReceiptPO receiptPO = receiptCommandService.getByOrderSn(orderSn);
    //	// 查询订单和自订单，然后写入vo返回
    ...
    //
    //	// 记录订单流水
    //	storeFlowQueryService.payOrder(orderSn);
    //
    //	// 发送订单已付款消息
    ...
    //	OrderLogPO orderLogPO = new OrderLogPO(orderSn, -1L, UserEnum.SYSTEM.name(), "系统操作",
    // message);
    ...
    //
    // @Override
    // @OrderLogPoint(description = "'订单['+#orderSn+']发货，发货单号['+#logisticsNo+']'", orderSn =
    // "#orderSn")
    ...
    //		// 修改订单货物可以进行售后、投诉
    //		orderItemCommandService.update(new UpdateWrapper<OrderItem>()
    ...
    //
    // @Override
    // @OrderLogPoint(description = "'订单['+#orderSn+']核销，核销码['+#verificationCode+']'", orderSn =
    // "#orderSn")
    // public OrderPO take(String orderSn, String verificationCode) {
    //	// 获取订单信息
    //	OrderPO orderPO = this.getBySn(orderSn);
    ...
    //	List<OrderItem> orderItems = orderItemCommandService.getByOrderSn(orderSn);
    ...
    //	this.orderItemCommandService.update(orderItemLambdaUpdateWrapper);
    // }
    //
    // @Override
    // public Boolean invoice(String sn) {
    //	// 根据订单号查询发票信息
    //	ReceiptPO receiptPO = receiptCommandService.getByOrderSn(sn);
    //	// 校验发票信息是否存在
    //	if (receiptPO != null) {
    //		receiptPO.setReceiptStatus(1);
    //		return receiptCommandService.updateById(receiptPO);
    //	}
    ...
    // public BigDecimal getPaymentTotal(String orderSn) {
    //	OrderPO orderPO = this.getBySn(orderSn);
    //	TradePO tradePO = tradeQueryService.getBySn(orderPO.getTradeSn());
