...
public interface OrderQueryService extends CommandService {
    ...
    //
    //	public PagedList<QListOrder> pagedList(Pagination pagination, int count, List<QListOrder>
    // apps);
    ...
    //     * @since 2022-04-28 08:54:47
    //     */
    ////    List<OrderPO> queryListByPromotion(String orderPromotionType, String payStatus, String
    ...
    //     * @since 2022-04-28 08:54:47
    //     */
    //    long queryCountByPromotion(String orderPromotionType, String payStatus, String
    // parentOrderSn, String orderSn);
    //
    //    /**
    //     * 父级拼团订单分组
    ...
    //     * @return 订单支付记录分页
    //     */
    //    IPage<PaymentLogCO> queryPaymentLogs(IPage<PaymentLogCO> page, Wrapper<PaymentLogCO>
    // queryWrapper);
}
