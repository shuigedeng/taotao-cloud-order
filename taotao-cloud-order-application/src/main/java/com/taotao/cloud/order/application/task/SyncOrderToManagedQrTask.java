...
// page.getControls().stream().collect(toImmutableMap(Control::getId, identity()));
//
//        FIdentifierControl orderIdControl = (FIdentifierControl)
// allControls.get(ORDER_ID_CONTROL_ID);
//        IdentifierAnswer orderIdAnswer =
// IdentifierAnswer.answerBuilder(requireNonNull(orderIdControl))
//                .content(order.getId())
//                .build();
//
//        FDropdownControl orderTypeControl = (FDropdownControl)
// allControls.get(ORDER_TYPE_CONTROL_ID);
...
//        };
//
//        DropdownAnswer orderTypeAnswer =
// DropdownAnswer.answerBuilder(requireNonNull(orderTypeControl))
//                .optionIds(List.of(optionId))
//                .build();
//
//        FItemStatusControl orderStatusControl = (FItemStatusControl)
// allControls.get(ORDER_STATUS_CONTROL_ID);
...
//        };
//        ItemStatusAnswer orderStatusAnswer =
// ItemStatusAnswer.answerBuilder(requireNonNull(orderStatusControl))
//                .optionId(statusId)
//                .build();
//
//        FSingleLineTextControl orderDetailControl = (FSingleLineTextControl)
// allControls.get(ORDER_DESCRIPTION_CONTROL_ID);
//        SingleLineTextAnswer orderDetailAnswer =
// SingleLineTextAnswer.answerBuilder(requireNonNull(orderDetailControl))
//                .content(order.description())
//                .build();
//
//        FNumberInputControl orderPriceControl = (FNumberInputControl)
// allControls.get(ORDER_PRICE_CONTROL_ID);
//        NumberInputAnswer orderPriceAnswer =
// NumberInputAnswer.answerBuilder(requireNonNull(orderPriceControl))
...
//
//        FPersonNameControl orderSubmitterControl = (FPersonNameControl)
// allControls.get(ORDER_SUBMITTER_CONTROL_ID);
//        PersonNameAnswer orderSubmitterAnswer =
// PersonNameAnswer.answerBuilder(requireNonNull(orderSubmitterControl))
//                .name(member != null ? member.getName() : null)
//                .build();
//
//        FMobileNumberControl submitterMobileControl = (FMobileNumberControl)
// allControls.get(ORDER_SUBMITTER_MOBILE_CONTROL_ID);
//        MobileNumberAnswer submitterMobileAnswer =
// MobileNumberAnswer.answerBuilder(requireNonNull(submitterMobileControl))
//                .mobileNumber(member != null ? member.getMobile() : null)
//                .build();
//
//        FEmailControl submitterEmailControl = (FEmailControl)
// allControls.get(ORDER_SUBMITTER_EMAIL_CONTROL_ID);
//        EmailAnswer submitterEmailAnswer =
// EmailAnswer.answerBuilder(requireNonNull(submitterEmailControl))
//                .email(member != null ? member.getEmail() : null)
//                .build();
//
//        FDropdownControl orderChannelControl = (FDropdownControl)
// allControls.get(ORDER_CHANNEL_CONTROL_ID);
...
//        };
//        DropdownAnswer orderChannelAnswer =
// DropdownAnswer.answerBuilder(requireNonNull(orderChannelControl))
//                .optionIds(List.of(channelOptionId))
//                .build();
//
//        FIdentifierControl wxTxnIdControl = (FIdentifierControl)
// allControls.get(ORDER_WX_TXN_CONTROL_ID);
//        IdentifierAnswer wxTxnIdAnswer =
// IdentifierAnswer.answerBuilder(requireNonNull(wxTxnIdControl))
//                .content(order.getPaymentType() == WX_NATIVE ? order.getWxTxnId() : "不适用")
//                .build();
//
//        FSingleLineTextControl bankAccountControl = (FSingleLineTextControl)
// allControls.get(ORDER_BANK_ACCOUNT_CONTROL_ID);
//        SingleLineTextAnswer bankAccountAnswer =
// SingleLineTextAnswer.answerBuilder(requireNonNull(bankAccountControl))
//                .content(order.getPaymentType() == BANK_TRANSFER ?
//                        (isNotBlank(order.getBankName()) ? order.getBankName() +
// order.getBankTransferAccountId() : null) :
//                        "不适用")
//                .build();
//
//        FItemStatusControl deliveryStatusControl = (FItemStatusControl)
// allControls.get(ORDER_DELIVERY_STATUS_CONTROL_ID);
...
//        }
//        ItemStatusAnswer deliveryStatusAnswer =
// ItemStatusAnswer.answerBuilder(requireNonNull(deliveryStatusControl))
//                .optionId(statusOptionId)
//                .build();
//
//        FDropdownControl deliverControl = (FDropdownControl)
// allControls.get(ORDER_DELIVER_CONTROL_ID);
...
//            };
//        }
//        DropdownAnswer deliverAnswer =
// DropdownAnswer.answerBuilder(requireNonNull(deliverControl))
//                .optionIds(isBlank(deliverOptionId) ? List.of() : List.of(deliverOptionId))
//                .build();
//
//        FIdentifierControl deliveryIdControl = (FIdentifierControl)
// allControls.get(ORDER_DELIVERY_ID_CONTROL_ID);
//        IdentifierAnswer deliveryIdAnswer =
// IdentifierAnswer.answerBuilder(requireNonNull(deliveryIdControl))
//                .content(order.getDelivery() != null ? order.getDelivery().getDeliveryOrderId() :
// null)
//                .build();
//
//        FItemStatusControl invoiceStatusControl = (FItemStatusControl)
// allControls.get(ORDER_INVOICE_STATUS_CONTROL_ID);
...
//        }
//        ItemStatusAnswer invoiceStatusAnswer =
// ItemStatusAnswer.answerBuilder(requireNonNull(invoiceStatusControl))
//                .optionId(invoiceStatusOptionId)
//                .build();
//
//        FMultiLineTextControl invoiceInfoControl = (FMultiLineTextControl)
// allControls.get(ORDER_INVOICE_INFO_CONTROL_ID);
//        String content = null;
...
//                      "申请时间：" + ((invoice.getRequestedAt() != null) ?
// MRY_DATE_TIME_FORMATTER.format(invoice.getRequestedAt()) : "") + "\n" +
//                      "开具时间：" + ((invoice.getIssuedAt() != null) ?
// MRY_DATE_TIME_FORMATTER.format(invoice.getIssuedAt()) : "") + "\n" +
...
//        }
//
//        MultiLineTextAnswer invoiceInfoAnswer =
// MultiLineTextAnswer.answerBuilder(requireNonNull(invoiceInfoControl))
//                .content(content)
//                .build();
//
//        FFileUploadControl invoiceFileControl = (FFileUploadControl)
// allControls.get(ORDER_INVOICE_FILE_CONTROL_ID);
//        FileUploadAnswer invoiceFileAnswer =
// FileUploadAnswer.answerBuilder(requireNonNull(invoiceFileControl))
//                .files(order.getInvoice() != null ? emptyIfNull(order.getInvoice().getFiles()) :
// List.of())
//                .build();
//
//        FFileUploadControl screenShotsControl = (FFileUploadControl)
// allControls.get(ORDER_SCREENSHOTS_CONTROL_ID);
//        FileUploadAnswer screenShotsAnswer =
// FileUploadAnswer.answerBuilder(requireNonNull(screenShotsControl))
//                .files(emptyIfNull(order.getScreenShots()))
//                .build();
//
//        FIdentifierControl tenantIdControl = (FIdentifierControl)
// allControls.get(ORDER_TENANT_CONTROL_ID);
//        IdentifierAnswer tenantIdAnswer =
// IdentifierAnswer.answerBuilder(requireNonNull(tenantIdControl))
//                .content(order.getTenantId())
//                .build();
//
//        return Set.of(orderIdAnswer, orderTypeAnswer, orderStatusAnswer, orderDetailAnswer,
// orderPriceAnswer, orderSubmitterAnswer,
//                submitterMobileAnswer, submitterEmailAnswer, orderChannelAnswer, wxTxnIdAnswer,
//                bankAccountAnswer, deliveryStatusAnswer, deliverAnswer, deliveryIdAnswer,
// invoiceStatusAnswer,
