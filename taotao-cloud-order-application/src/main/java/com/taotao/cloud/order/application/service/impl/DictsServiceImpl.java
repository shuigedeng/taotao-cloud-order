...
import com.taotao.cloud.order.application.command.dict.dto.DictDeleteCmd;
import com.taotao.cloud.order.application.command.dict.dto.DictGetQry;
import com.taotao.cloud.order.application.command.dict.dto.DictInsertCmd;
import com.taotao.cloud.order.application.command.dict.dto.DictListQry;
import com.taotao.cloud.order.application.command.dict.dto.DictOptionListQry;
import com.taotao.cloud.order.application.command.dict.dto.DictUpdateCmd;
import com.taotao.cloud.order.application.command.dict.dto.clientobject.DictCO;
import com.taotao.cloud.order.application.command.dict.dto.clientobject.OptionCO;
import com.taotao.cloud.order.application.command.dict.executor.DictDeleteCmdExe;
import com.taotao.cloud.order.application.command.dict.executor.DictInsertCmdExe;
import com.taotao.cloud.order.application.command.dict.executor.DictUpdateCmdExe;
import com.taotao.cloud.order.application.command.dict.executor.query.DictGetQryExe;
import com.taotao.cloud.order.application.command.dict.executor.query.DictListQryExe;
import com.taotao.cloud.order.application.command.dict.executor.query.DictOptionListQryExe;
