...
import com.taotao.cloud.order.domain.valobj.order.DeliverStatusEnum;
import com.taotao.cloud.order.domain.valobj.order.OrderPromotionTypeEnum;
import com.taotao.cloud.order.domain.valobj.order.OrderStatusEnum;
...
public class OrderPO extends BasePO<OrderPO> {
