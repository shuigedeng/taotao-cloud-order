...
@org.springframework.data.relational.core.mapping.Table(name = OrderRefundPaySeqPO.TABLE_NAME)
public class OrderRefundPaySeqPO extends BasePO<OrderRefundPaySeqPO> {
