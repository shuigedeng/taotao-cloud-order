...
import com.taotao.cloud.order.common.constant.OrderConstant;
...
@org.springframework.data.relational.core.mapping.Table(name = OrderInfoPO.TABLE_NAME)
public class OrderInfoPO extends BasePO<OrderInfoPO> {
