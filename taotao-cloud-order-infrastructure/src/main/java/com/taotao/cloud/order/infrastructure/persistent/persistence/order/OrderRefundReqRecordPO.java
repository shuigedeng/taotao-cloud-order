...
@org.springframework.data.relational.core.mapping.Table(name = OrderRefundReqRecordPO.TABLE_NAME)
public class OrderRefundReqRecordPO extends BasePO<OrderRefundReqRecordPO> {
